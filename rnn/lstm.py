...
Adapted from tensorflow/models/tutorials/rnn/ptb/ptb_word_lm.py
[Copyright 2015 The TensorFlow Authors. All Rights Reserved.]

Model 1
Input: 4 possible fix locations (null, left, right, END)
Output: 4 possible fix locations (null, left, right, null, END)
...
To run:
$ python lstm.py --model=small --save_path=my_model
"""
...
class Input(object):
    ...
    def __init__(self, config, data, name=None):
        ...
        self.input_data, self.targets = reader.model_1_producer(
...
class Model(object):
    ...
    def __init__(self, is_training, config, input_):
        ...
        # Before restacking, output size is [batch_size x hidden_size]
        # After restacking, output size is
        # [(batch_size x num_steps) x hidden_size]
...
def main(_):
    raw_data = reader.get_model_1_raw_data()
